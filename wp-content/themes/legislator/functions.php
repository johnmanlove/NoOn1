...
function rescue_scripts() {
     ...
     */
    $legislator = wp_get_theme();

    // Enqueue Styles & Scripts
    wp_enqueue_style( 'foundation_style', get_template_directory_uri() . '/css/foundation.min.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'google-font-fjalla-one', '//fonts.googleapis.com/css?family=Fjalla+One');
    wp_enqueue_style( 'google-font-sigmar-one', '//fonts.googleapis.com/css?family=Sigmar+One');
    wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css', array(), '4.1.0', 'all' );
    ...
    wp_enqueue_style( 'rescue_style', get_stylesheet_uri(), array(), $legislator['Version'] );

    wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/vendor/modernizr.js', array( 'jquery' ), '', false ); 
    wp_enqueue_script( 'classie');
    wp_enqueue_script( 'uisearch'); 

    wp_enqueue_script( 'foundation', get_template_directory_uri() . '/js/foundation.min.js', array( 'jquery' ), '', false ); 
    ...
    wp_enqueue_script( 'fancybox_pack_js', get_template_directory_uri() . '/inc/fancybox/jquery.fancybox.pack.js', array( 'jquery' ), '', false ); 
    ...
    wp_enqueue_script( 'foundation_tooltip', get_template_directory_uri() . '/js/foundation/foundation.tooltip.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'basic_jquery_slider', get_template_directory_uri() . '/js/bjqs-1.3.min.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'rescue_scripts', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ), $legislator['Version'], true );
