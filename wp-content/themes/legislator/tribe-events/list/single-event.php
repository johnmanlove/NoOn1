...
<div class="row clearfix">
	...
	?>
		...
		<div class="large-12 columns">
            <a href="<?php the_permalink(); ?>" class="featured_image_post inner_link_hover" title="<?php the_title(); ?>"><img alt="" src="<?php echo esc_url( $image ); ?>" /></a>
...
<div class="row">
	...
	<div class="tribe-events-list-event-description tribe-events-content description entry-summary">
		<?php the_excerpt() ?>
		<a href="<?php echo esc_url( tribe_get_event_link() ); ?>" class="tribe-events-read-more" rel="bookmark"><?php _e( 'Find out more', 'rescue' ) ?> &raquo;</a>
